...
export default function teamModal({ modalVisible, setModalVisible }) {
				...
				<View style={styles.modalContainer}>
					...
					<TouchableOpacity style={{
						...
						<View style={{ flex: 0.15, alignItems: 'center' }}>
							{/* <MaterialCommunityIcons name="close" color={COLORS.primaryGreen} size={20} /> */}
							<Image source={individualPerforamance} style={{ height: 20, width: 20, resizeMode: 'contain' }} />
						</View>

						<View style={{ flex: 0.85, }}>
							<Text style={{ fontSize: 15, fontFamily: Fonts.Roboto.Medium, color: COLORS.islandRank }}>Team Statistics</Text>
						</View>
					</TouchableOpacity>
					...
					<TouchableOpacity style={{
						...
						<View style={{ flex: 0.85, }}>
							<Text style={{ fontSize: 15, fontFamily: Fonts.Roboto.Medium, color: COLORS.islandRank }}>Current Performance</Text>
						</View>
					</TouchableOpacity>
					...
					<TouchableOpacity style={{
						...
						<View style={{ flex: 0.85, }}>
							<Text style={{ fontSize: 15, fontFamily: Fonts.Roboto.Medium, color: COLORS.islandRank }}>Branch sales performance</Text>
						</View>
					</TouchableOpacity>
				</View>
			</Animated.View>
