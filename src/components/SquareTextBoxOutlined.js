...
export default function SquareTextBoxOutlined({ Label, Title, Secure, value, keyboardType, setValue, errorBorder }) {
  ...
  return (
    <View style={{ width: '100%', marginTop: window.height * 0.01 }}>
      {Label && (
        <Text style={{ marginBottom: 5, fontFamily: Fonts.Roboto.Bold, color: COLORS.textColor }}>
          {Label}
        </Text>
      )}
