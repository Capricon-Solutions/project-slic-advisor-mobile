				...
				<View style={styles.modalContainer}>
					...
					<TouchableOpacity style={{
						...
						<View style={{ flex: 0.85, }}>
							<Text style={{ fontSize: 15, fontFamily: Fonts.Roboto.Medium, color: COLORS.islandRank }}>Individual Statistics</Text>
						</View>
					</TouchableOpacity>
					...
					<TouchableOpacity style={{
						...
						<View style={{ flex: 0.85, }}>
							<Text style={{ fontSize: 15, fontFamily: Fonts.Roboto.Medium, color: COLORS.islandRank }}>Individual performance Comparison</Text>
						</View>
					</TouchableOpacity>
