...
export default function SalesModal({ modalVisible, setModalVisible, onPressOne, onPressTwo }) {
			...
			>
				<View style={styles.modalContainer}>
					...
					<TouchableOpacity
						...
						<View style={{ flex: 0.15, alignItems: 'center' }}>
							<Image source={teamPerformance} style={{ height: 20, width: 20, resizeMode: 'contain' }} />
						</View>
						<View style={{ flex: 0.85 }}>
